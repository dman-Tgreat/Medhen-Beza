    ...
    <div className="container mx-auto px-4 py-8 lg:py-12">
      ...
      <div className="mb-10 rounded-2xl border border-border bg-surface p-4 sm:p-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="relative flex-1">
            ...
            <Input
              type="search"
              placeholder="Search clinical services, procedures, diagnostic tests..."
              value={searchQuery}
      ...
      {groupedDepartments.length === 0 ? (
        <EmptyState
          ...
          description="We couldn't find any clinical services matching your search. Please check your keywords or reset filters."
          ...
          {groupedDepartments.map(({ department, services }) => (
            <div key={department.slug} className="space-y-6">
              <div className="flex items-center justify-between border-b border-border pb-3">
                ...
                >
                  Department Details <ArrowRight className="h-3.5 w-3.5" />
                </Link>
              </div>
