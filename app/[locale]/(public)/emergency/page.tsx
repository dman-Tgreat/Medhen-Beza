...
export async function generateMetadata(props: {
  ...
  return {
    title: dict.nav?.emergency || "Emergency Services 24/7",
...
export default async function EmergencyPage(props: {
  ...
  const [settings, dbPage, dict] = await Promise.all([
    getPublicSiteSettings(locale),
    getPublicPageBySlug("emergency", locale),
    getDictionary(locale),
  ]);
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <PageHero
        eyebrow={dict.home?.emergencyCare || "24/7 Trauma & Critical Response"}
        ...
        breadcrumbs={[{ label: dict.nav?.emergency || "Emergency" }]}
      />
      ...
      <main className="layout-container pt-8 space-y-10 max-w-4xl mx-auto">
        ...
        {/* 3. Plain-Language Scannable Instructions */}
